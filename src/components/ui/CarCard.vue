...
<template>
    <div class="shadow-2xl flex flex-col lg:flex-row">
        ...
        <div class="w-full lg:w-130 border-b-3 lg:border-b-0 lg:border-r-3 border-[#000000]">
            <img class="max-lg:aspect-3/2 max-lg:px-0 px-10 py-8 lg:py-0 w-full h-auto object-contain"
                :src="`/public/${img}`" alt="">
        </div>
        ...
        <div class="flex flex-col flex-1">
            ...
            <h3 class="px-4 py-3 lg:py-2 text-xl font-medium">
                Автомобиль седан до 4-х мест
            </h3>

            <div class="inline-block  max-lg:text-sm max-lg:pt-0 text-base px-4 py-4 flex-1 leading-relaxed">
                Забираем от Аэропорта Сочи, железнодорожный вокзал Адлер, либо по указанному адресу!
                Трансфер на комфортном автомобиле седан - посадка до 4-х мест.
            </div>
                ...
                <div
                    ...
                    <div class="max-md:justify-between max-md:w-full flex items-center flex-wrap gap-x-4">
                        ...
                        <div class="flex items-center gap-x-2">
                            ...
                            <span class="text-xl text-white font-semibold">4</span>
                        </div>
                    </div>

                    <!-- Кнопка "Заказать" -->
                    <div class="box-border max-md:mx-auto max-lg:px-3 max-lg:py-1 border-3 px-6 py-2.5 text-white  
